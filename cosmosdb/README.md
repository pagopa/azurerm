...
| <a name="input_additional_geo_locations"></a> [additional\_geo\_locations](#input\_additional\_geo\_locations) | n/a | <pre>list(object({<br>    location          = string<br>    failover_priority = number<br>  }))</pre> | `[]` | no |
