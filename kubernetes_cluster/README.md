...
| <a name="input_enable_azure_keyvault_secrets_provider"></a> [enable\_azure\_keyvault_secrets_provider](#input\_enable\_azure\_keyvault_secrets_provider) | Should the Azure Secrets Store CSI addon be enabled for this Node Pool? | `bool` | `false` | no |
